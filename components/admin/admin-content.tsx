  ...
  return (
    <Tabs defaultValue="usuarios">
      ...
      <TabsContent value="roles">
        <div className="rounded-2xl border border-[#D4B896]/40 bg-white shadow-[0_2px_8px_rgba(0,0,0,0.06)] p-6 text-center space-y-3">
      ...
      <TabsContent value="divisiones">
        <div className="space-y-4">
          {divisiones.map((div) => (
            <div key={div.id} className="rounded-xl border border-[#D4B896]/40 bg-white shadow-[0_1px_4px_rgba(0,0,0,0.05)] p-4">
